...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>EDMS | User Management</title>
...
body{
  ...
  .navbar.navbar-expand-md.navbar-dark.bg-dark.card-header{
    border-radius: 15px;
    background: #fff;
  }
</style>
<div class="colorH">
    ...
    <div class="container">
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-dark card-header">
        <a class="navbar-brand" href="index.php"><i class="fas fa-home mr-2"></i>User Dashboard</a>
